// Word bank for target words (2315 words from Wordle)
...
// Pick 8 words for daily puzzle based on date
export function getDailyTargetWords(dateString?: string): string[] {
